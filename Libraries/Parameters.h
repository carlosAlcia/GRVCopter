...
/*
    ...
    If the UAV has already a file ParametersList.carlos with the params values, add the new one at the bottom with the desired value.
    If there is not a file ParametersList.carlos yet, it will be created the first time launching GRVCOPTER.
*/
...
namespace PARAMS
{
    ...
    private:
        string filename = "Params/ParametersList.carlos";
        std::ofstream file;
